<?php 
            if(isset($_POST["update"])) {
                    ...
                    if(count($errors) > 0) {
                        ...
                        $update_sql = "UPDATE content_creator SET Cont_Fname = '$fname', Cont_Lname = '$lname', Cont_email = '$email', Cont_password = '$password', Cont_contactNO = '$contactNO' WHERE Cont_ID = '$hiddencons_idh'";
